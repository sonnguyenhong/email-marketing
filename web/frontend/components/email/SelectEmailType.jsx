  ...
  return (
    <div>
        ...
        <Grid>
          <Grid.Cell columnSpan={{ xs: 4, sm: 2, md: 2, lg: 4, xl: 4 }}>
            <LegacyCard sectioned>
              <p style={{ fontSize:"20px", fontWeight: "bold", textDecoration: "underline" }}>Event Comming</p>
          ...
          <Grid.Cell columnSpan={{ xs: 4, sm: 2, md: 2, lg: 4, xl: 4 }}>
            <LegacyCard sectioned>
              <p style={{ fontSize:"20px", fontWeight: "bold", textDecoration: "underline" }}>Gift Reminder</p>
              <div className="template-email-card">
                <img
                  alt="Black choker necklace"
          ...
          <Grid.Cell columnSpan={{ xs: 4, sm: 2, md: 2, lg: 4, xl: 4 }}>
            <LegacyCard sectioned>
              <p style={{ fontSize:"20px", fontWeight: "bold", textDecoration: "underline" }}>New Blog</p>
              <div className="template-email-card">
                <img
                  alt="Black choker necklace"
                  src="../../assets/blog.png"
              ...
              <div className="div-btn">
                <Button onClick={() => chooseTemplate("blog")}>
                  Select
                </Button>
              </div>
            </LegacyCard>
      ...
      <Layout.Section>
        ...
        <Grid.Cell columnSpan={{ xs: 4, sm: 2, md: 2, lg: 4, xl: 4 }}>
            <LegacyCard sectioned>
              <p style={{ fontSize:"20px", fontWeight: "bold", textDecoration: "underline" }}>Gift Guider</p>
              <div className="template-email-card">
                <img
                  alt="Black choker necklace"
          ...
          <Grid.Cell columnSpan={{ xs: 4, sm: 2, md: 2, lg: 4, xl: 4 }}>
            <LegacyCard sectioned>
              <p style={{ fontSize:"20px", fontWeight: "bold", textDecoration: "underline" }}>Comming soon</p>
              <img
                alt="Black choker necklace"
